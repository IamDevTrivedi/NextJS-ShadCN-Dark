      ...
      <div className="flex flex-col md:flex-row gap-2">
        ...
        <div className="w-full md:w-3/5">
          ...
          <p className="text-muted-foreground mb-6">
            Prefer chatting on mobile? Use our official Telegram bot for the
            same powerful features — right from your phone. Fast, secure, and
            always available.
          </p>
        ...
        <div className="w-full md:w-2/5 flex justify-center">
          <a
            href="http://t.me/talkasauras_bot"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Image
