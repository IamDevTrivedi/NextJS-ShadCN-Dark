    ...
    <div className="container mx-auto py-10 px-4 space-y-8">
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none">
        <p className="text-foreground leading-7">
          At Talkasaurus, we value your privacy and are committed to protecting your personal data. This Privacy Policy
      ...
      <Card className="border bg-card text-card-foreground">
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-foreground leading-7">
            Talkasaurus uses your chat history <strong>only</strong> to improve your individual chat experience. This
            allows us to provide more relevant and personalized responses based on your previous interactions.
          </p>
          ...
          <p className="text-foreground leading-7">
            ...
            Your conversations remain private and are not used for analytics or advertising purposes.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="border bg-card text-card-foreground">
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-foreground leading-7">
            We retain your chat history only for as long as necessary to fulfill the purposes outlined in this Privacy
            Policy. You can request deletion of your data at any time.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="border bg-card text-card-foreground">
        <CardHeader>
          ...
          <CardDescription>Our approach to cookies and similar technologies</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-foreground leading-7">
            We use only essential cookies that are necessary for the functioning of our service. We do not use tracking
            cookies or similar technologies for marketing or analytics purposes.
          </p>
        </CardContent>
      </Card>
