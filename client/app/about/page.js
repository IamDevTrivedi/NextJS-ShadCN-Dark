  ...
  const features = [
    {
      ...
      description: "Our AI understands context and nuance, enabling natural, flowing conversations that feel human-like and intuitive."
    },
    {
      icon: <MessageSquare className="h-6 w-6 text-primary" />,
      title: "Personalized Experience",
      description: "Talkasaurus learns from your interactions to provide increasingly relevant and helpful responses tailored to your needs."
    },
    {
      icon: <Shield className="h-6 w-6 text-primary" />,
      title: "Privacy-Focused",
      description: "Your data is yours alone. We use your chat history only to improve your individual experience, never for analytics or third parties."
    },
    {
      icon: <Sparkles className="h-6 w-6 text-primary" />,
      title: "Continuous Improvement",
      description: "Our AI is constantly evolving, with regular updates that enhance capabilities, fix issues, and introduce new features."
    }
  ]
